...
WYMeditor.editor.prototype.replacestrings = function (sVal) {
    ...
    if (!WYMeditor.STRINGS[this._options.lang]) {
        ...
        + this._options.lang + '.js', async: false
            }).responseText);
        } catch (e) {
...
WYMeditor.editor.prototype.computeBasePath = function () {
    return $(jQuery.grep($('script'), function (s) {
...
WYMeditor.editor.prototype.computeCssPath = function () {
    return $(jQuery.grep($('link'), function (s) {
...
WYMeditor.INIT_DIALOG = function (index) {
    ...
    var dialogType = $(wym._options.dialogTypeSelector).val();
    ...
    $(wym._options.dialogLinkSelector + " "
    ...
    $(wym._options.dialogTableSelector + " "
    + wym._options.submitSelector).click(function () {
    ...
    $(wym._options.dialogPasteSelector + " "
    + wym._options.submitSelector).click(function () {

        var sText = $(wym._options.textSelector).val();
        wym.paste(sText);
        window.close();
    });
    ...
    //cancel button
    $(wym._options.cancelSelector).mousedown(function () {
        window.close();
    });
